...
//    showmsgXY(20, 20, 1, NULL, "System x1");
//    showmsgXY(20, 24, 2, NULL, "System x2");
//    showmsgXY(20, 60, 1, &FreeSans9pt7b, "FreeSans9pt7b");
                    //showmsgXY(10, 200, 4, &FreeSans10pt8b, "Lat Кир!");
      for(int i = 0; i < 4; i++)
      {
        canvas.fillScreen(WHITE);
        canvas.drawBitmap(0, 0, epd_bitmap_allArray[i], 32, 32, BLACK);
        tft.drawBitmap(10, 10, canvas.getBuffer(), 200, 200, WHITE, BLACK);
        delay(500);
      }
